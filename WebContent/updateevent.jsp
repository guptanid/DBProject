				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<input type="text" class="form-control" id="eventName"
							name="eventName" value=${requestScope.event.getDescription() }>
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-sm-10">
						<input type="text" class="form-control" id="eventLocation"
							name="eventLocation" value=${requestScope.event.getLocation() }>
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-sm-10">
						<input type="date" class="form-control" id="eventStartDate"
							name="eventStartDate" value=${requestScope.event.getStartDate() }>
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-sm-10">
						<input type="Date" class="form-control" id="eventEndDate"
							name="eventEndDate" value=${requestScope.event.getEndDate() }>
					</div>
				</div>
				<div class="form-group">
					<label for="inputEmail3" class="col-sm-2 control-label">Start
					...
					<div class="col-sm-10">
						<input type="time" class="form-control" id="eventStartTime"
							name="eventStartTime" value=${requestScope.event.getStartTime() }>
					</div>
				</div>
				<div class="form-group">
					<label for="inputEmail3" class="col-sm-2 control-label">End
					...
					<div class="col-sm-10">
						<input type="time" class="form-control" id="eventEndTime"
							name="eventEndTime" value=${requestScope.event.getEndTime() }>
					</div>
				</div>
				<div class="form-group">
